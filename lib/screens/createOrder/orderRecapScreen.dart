      ...
      body: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            Flexible(child: Text("Total à payer : ${order?.totalCost.toMonetaryString()} DH")),
            order!.totalDiscount > 0 ? Flexible(child: Text("Total réduit : ${order!.totalDiscount.toMonetaryString()} DH")) : const SizedBox(height: 0,),
